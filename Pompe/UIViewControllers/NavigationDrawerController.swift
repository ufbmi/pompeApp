...
class NavigationDrawerController: UIViewController, DrawerMenuDelegate {
    ...
    func showProfile(){
        ...
        let profileController : ProfileViewController = UIStoryboard(name: "Profile", bundle: nil).instantiateViewController(withIdentifier: "profileViewController") as! ProfileViewController
        ...
        closeDrawerOnCompletion { (complete) in
            ...
            if complete {
                ...
                case 1:
                    ...
                    let fitBitController : FitbitAuthViewController = UIStoryboard(name: "Fitbit", bundle: nil).instantiateViewController(withIdentifier: "fitBitLog") as! FitbitAuthViewController

                    if let navigationController = self.frontViewController as? UINavigationController{
                        
                        navigationController.pushViewController(fitBitController, animated: false)
                    }
                ...
                case 2:
                    ...
                    let weightController : WeightViewController = UIStoryboard(name: "Weight", bundle: nil).instantiateViewController(withIdentifier: "weightLog") as! WeightViewController
                    
                    if let navigationController = self.frontViewController as? UINavigationController{
                        
                        navigationController.pushViewController(weightController, animated: false)
                    }
