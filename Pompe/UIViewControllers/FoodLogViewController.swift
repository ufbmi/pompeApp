...
class FoodLogViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, PiechartDelegate {
...
//    let healthManager:HealthManager = HealthManager()
    ...
    func updateCalories(){ //update cals num
        ...
        if (data == nil){
            ...
            navigationDrawerController().showProfile()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        if (segue.identifier == "sendData1") {
            ...
            let targetController = destinationNavigationController.topViewController as! LogFoodController
